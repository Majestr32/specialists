...
Future<void> showRemoveDiagramPopup(BuildContext context,
    {required String id}) {
  return showDialog(
      context: context,
      builder: (context) {
        return ConfirmationDialog(
          title: "Чи справді ти хочеш видалити діаграму?",
          onConfirm: () {
            context.read<SpecialistsDiagramsCubit>().removeDiagram(id: id);
